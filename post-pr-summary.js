  ...
  try {
    const response = await openai.chat.completions.create({
      ...
      messages: [
        ...
        { role: "user", content: `Summarize and review these code changes for ${file}. Your task is to review the provided code and offer concise, actionable feedback within 100 words or less in proper formatted, less wordy, bullets, focusing on issues, optimizations, and best practices. Any code changes that need to be made should be clearly stated in code blocks. Please ensure the feedback is within a limit of 200 tokens.:\n\n${diff}` }
      ],
      max_tokens: 800,
    });
